...
class Partner_Accepted_AjaxOrderParam extends Base_AjaxBase
{
    ...
    function _execute(&$form)
    {
        ...
        from
            ...
            left join (select item_id, default_location_id, measure from item_master) as t1 on order_detail.item_id = t1.item_id
