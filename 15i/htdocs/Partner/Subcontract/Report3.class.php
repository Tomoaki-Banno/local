...
class Partner_Subcontract_Report3 extends Base_PDFReportBase
{
    ...
    protected function _getQuery(&$form)
    {
        ...
        $query = "
            select
                ...
                order_header_subcontract.partner_id
            ...
            order by
                ...
                customer_master_partner.customer_no, order_detail_subcontract.order_no, order_detail_subcontract.line_no
        ";
    ...
    {
        $info = array();
        $info['reportTitle'] = _g("外製指示書（リスト）");
        $info['report'] = "PartnerSubcontract3";
