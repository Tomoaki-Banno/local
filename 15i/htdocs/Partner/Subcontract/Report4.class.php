...
class Partner_Subcontract_Report4 extends Base_PDFReportBase
{
    ...
    protected function _getQuery(&$form)
    {
        ...
        $query = "
            select
                ...
                order_header_subcontract.partner_id as partner_id
            ...
            order by
                ...
                customer_master_partner.customer_no, order_no, t_child_item_master.item_group_id, t_child_item_master.item_code
        ";
    ...
    {
        $info = array();
        $info['reportTitle'] = _g("払出表（発注先別）");
        $info['report'] = "PartnerSubcontract4";
