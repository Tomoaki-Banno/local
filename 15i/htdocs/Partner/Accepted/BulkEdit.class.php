...
class Partner_Accepted_BulkEdit extends Base_ListBase
{
    ...
    function setViewParam(&$form)
    {
        ...
        $form['gen_pageTitle'] = _g("一括注文受入");
        $form['gen_menuAction'] = "Menu_Partner";
        $form['gen_listAction'] = "Partner_Accepted_BulkEdit";
        ...
        $form['gen_returnUrl'] = "index.php?action=Partner_Accepted_List&gen_restore_search_condition=true";
        $form['gen_returnCaption'] = _g('受入登録へ戻る');
        ...
        if ($form['gen_readonly'] == 'true') {
            ...
            $html_location_id = Gen_String::makeSelectHtml("location_id", $opt, @$form['location_id'], "", "Partner_Accepted_BulkEdit", @$form['gen_pins']);
        ...
        $form['gen_javascript_noEscape'] = "
            function bulkEdit() {
                ...
                var postUrl = 'index.php?action=Partner_Accepted_BulkEntry';
