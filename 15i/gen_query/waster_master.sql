drop table if exists waster_master;
create table waster_master
(
    waster_id serial primary key,       /* 不適合理由id */
    waster_code text unique not null,   /* 不適合理由コード */
    waster_name text not null,          /* 不適合理由名 */
    remarks text,                       /* 備考 */
